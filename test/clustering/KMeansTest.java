...
public class KMeansTest {
    ...
    public ArrayList<ArrayList<String>> determineClusters(int[] clusters) {
    	...
    	for (int i : clusters) {
    		switch (i) {
    		case 0:
    			cluster0.add(this.data.instance(numInst).toString());
    			break;
    		case 1:
    			cluster1.add(this.data.instance(numInst).toString());
    			break;
    		case 2:
    			cluster2.add(this.data.instance(numInst).toString());
    			break;
    		default:
   ...
   /**
    ...
    public void threeInstancesOneCluster1KMeansTest() throws Exception {
        ...
        kmeans.setNumIterations(100);
        kmeans.setChooseInitCentroids(true);
        System.out.println("---------- Three Instances, One Cluster (0 done) ----------");
        kmeans.cluster();
    ...
    public void threeInstancesOneCluster2KMeansTest() throws Exception {
        ...
        kmeans.setNumIterations(100);
        kmeans.setChooseInitCentroids(true);
        System.out.println("---------- Three Instances, One Cluster (1 done) ----------");
        kmeans.cluster();
    ...
    public void threeInstancesOneCluster3KMeansTest() throws Exception {
        ...
        kmeans.setNumIterations(100);
        kmeans.setChooseInitCentroids(true);
        System.out.println("---------- Three Instances, One Cluster (2 done) ----------");
        kmeans.cluster();
   ...
   /**
    ...
    public void threeInstancesThreeClustersKMeansTest() throws Exception {
        ...
        kmeans.setNumIterations(100);
        kmeans.setChooseInitCentroids(true);
        System.out.println("---------- Three Instances, three Clusters (0 1 2 done) ----------");
        kmeans.cluster();
